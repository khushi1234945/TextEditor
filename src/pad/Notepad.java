...
boolean newFileFlag;
String fileName;
String applicationTitle="Squarepad";
...
{
JOptionPane.showMessageDialog(Notepad.this.f,aboutText,"Author",JOptionPane.INFORMATION_MESSAGE);
}
else
...
final String helpAboutNotepad="About Author";

final String aboutText=
	"<html><big>Squarepad</big><hr><hr>"
	+"<p align=right>Prepared by Khushant Arora"
	+"<hr><p align=left>Myself: programmer, java addict.<br><br>"
	+"<hr><em><big>khushant1511.cse19@gmail.com</big></em><hr><html>";
}
